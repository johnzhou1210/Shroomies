...
public class ShroomSnailAI : EnemyShooting {
     ...
     */
        ...
        /*
         * BUGS:
         *  - BOUNCING BULLETS LOSE THEIR VELOCITY WHEN THEY HIT THE SNAIL BOSS'S SHELL DURING HIS ROLLOUT ATTACK
         *      BULLETS STAY AT REST UNTIL THEY TIME OUT AND DISSAPEAR
         *      DECIDED TO DISINTEGRATE BULLETS ON CONTACT INSTEAD OF RICOCHETING THEM OFF THE SHELL DURING ROLLOUT
         * 
         * SEEM TO BE FIXED:
         *  - SNAIL WIDE SWEEP.
         *      WIDE SWEEP DOES NOT SPAWN IN THE CORRECT POSITION
         *      FIX WAS TO CHANGE RIGIDBODY OF BULLET FROM DYNAMIC TO KINEMATIC
         *  - SNAIL TRIPLE SHOT
         *      TRIPLE SHOT SPAWNS IN THE CORRECT POSITION BUT THEN CHANGES TO AN INCORRECT POSITION AFTER ANOTHER TRIPLE SHOT GETS FIRED
         *      FIX WAS TO CHANGE RIGIDBODY OF BULLET FROM DYNAMIC TO KINEMATIC
         */
